          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
            <motion.div className="lg:col-span-3" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <div className="space-y-5 text-white/60 text-base leading-relaxed" style={BODY}>
                ...
                <p>Nuestra trayectoria nos ha permitido además consolidar un <strong className="text-foreground">convenio con botines <a href="https://ombuindumentaria.com.ar/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">OMBU</a></strong>, un respaldo de marca de primer nivel que avala nuestra vasta experiencia y profesionalismo en el rubro industrial.</p>
